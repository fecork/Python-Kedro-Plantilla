...
# kedro_template documentation build
...
from kedro_template import __version__ as release

import os
import sys

sys.path.insert(0, os.path.abspath(".."))
sys.path.append("kedro-template")
# -- Project information -----------------------------------------------------

project = "kedro_template"
author = "Kedro"
...
htmlhelp_basename = "kedro_templatedoc"
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_template",
        "Project kedro_template codebase.",
        "Nearest-Neighbour",
    )
]
